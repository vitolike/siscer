    ...
    <div class="container">
      <nav class="nav nav-underline">
        ...
        <a class="nav-link red-text" href="#" data-toggle="modal" data-target="#exampleModalCenter"><i class="far fa-file navbar-text"></i>&nbsp;&nbsp;Novo</a>
...
<?php elseif ($msg == 'atualizado'): ?>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Usuários administadores do sistema.</h6>
