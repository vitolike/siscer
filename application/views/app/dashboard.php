<div class="nav-scroller bg-white box-shadow ">
    <div class="container">
        <nav class="nav nav-underline">
            ...
            <a class="nav-link red-text" href="<?= base_url(); ?>integrantes/lista"><i class="fas fa-users navbar-text"></i>
        Integrantes
        </a>
...
<div class="form-row">
    <div class="form-group col-md-3">
        <div class="my-3 p-3 bg-white rounded box-shadow">
            <h6 class="card-title"><b>Total de integrantes</b></h6>
    ...
    <div class="form-group col-md-3">
        <div class="my-3 p-3 bg-white rounded box-shadow">
            <h6 class="card-title"><b>Produtos em estoque</b></h6>
            <div class="media text-muted pt-3">
    ...
    <div class="form-group col-md-3">
        <div class="my-3 p-3 bg-white rounded box-shadow">
            <h6 class="card-title"><b>Total de ativos</b></h6>
            <div class="media text-muted pt-3">
    ...
    <div class="form-group col-md-3">
        <div class="my-3 p-3 bg-white rounded box-shadow">
            <h6 class="card-title"><b>Vendas nos últimos 7 dias</b></h6>
            <div class="media text-muted pt-3">
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow table-responsive-md">
            ...
            <?php if(!$prod){?>
                <tbody>
                    <tr>
                        <td colspan="5">
                            <center>
                                <p class="texto_pequeno">Nenhum produto cadastrado</p>
                            </center>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tbody>
                        <?php foreach($prod as $p) {?>
                            ...
                            <tr id="<?= $p->produtosid; ?>">
                                ...
                                <td>
                                    <a href="<?= base_url(); ?>produtos/editar/<?= $p->produtosid; ?>">
                                        <button type="button" class="btn btn-success btn-sm">Detalhes <i class="fas fa-search"></i></button>
                                    </a>
                                </td>
                            </tr>
                            <?php }?>
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow table-responsive-md">
        ...
        <div class="row">&nbsp;</div>
        <table class="table" id="OS_abertas">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <?php if(!$query){?>
                <tbody>
                    <tr>
                        <td colspan="7">
                            <center>
                                <p class="texto_pequeno">Não há Ordem de serviço em aberto</p>
                            </center>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tbody>
                        <?php foreach($query as $prop) {?>
                            ...
                            <tr id="<?= $prop->idos; ?>">
                                ...
                                <td>
                                    <?php if ($prop->status == 'FINALIZADO'): ?><span class="badge badge-warning">FINALIZADO</span>
                                        <?php elseif ($prop->status == 'CANCELADO'): ?><span class="badge badge-danger">CANCELADO</span>
                                            <?php else: ?><span class="badge badge-success"><?= $prop->status; ?></span>
                                                <?php endif; ?>
                                </td>

                                <td>
                                    <a href="<?= base_url(); ?>os/detalhes/<?= $prop->idos; ?>">
                                        <button type="button" class="btn btn-success btn-sm">Detalhes <i class="fas fa-search"></i></button>
                                    </a>
