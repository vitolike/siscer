...
<head>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
		...
		<i class="fas fa-dove fa-9x"></i>
        <p>&nbsp;</p>
     <h1 class="h3 mb-3 font-weight-normal">Bem Vindo ao <b><?php echo $sysname ?></b> </h1>
      ...
      <button class="btn btn-lg btn-success btn-block" type="submit"><i class="fas fa-check"></i> Entrar</button>
